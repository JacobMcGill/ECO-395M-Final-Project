---
title: "ECO-395M Final Project: Musab Aluqaee, Daniel Oliner, and Jacob McGill"
output:
...
The best performing model is the Random Forest, followed by the Baseline, then the LASSO. However, random forest does not have a substantially higher RMSE, less than 0.1. These are also not that relatively large RMSEs. Since price is cents/kWh, these RMSE are a little more than half a cent/kWh.
