...
Next we will move onto the performance of the models we developed. We will start with the baseline kitchen sink model, then the LASSO model, and then finally the randomforest model
